...
plt.legend()
plt.savefig(
    os.path.join("result_modeling", "CR PvA Scatter.png"),
    dpi=400,
    bbox_inches="tight",
)
plt.close()

with open("model_errs_and_coefs/cubic_reg_errors.txt", "w") as fout:
...
coef_df.to_csv("model_errs_and_coefs/cubic_reg_coefs.csv")
